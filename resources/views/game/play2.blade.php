...
const Game = {
    state: {
        playerTeam: [
            ...
            { id: 2, name: "GEODUDE", hp: 40, maxHp: 40, mp: 20, maxMp: 20, attack: 15, defense: 20, sp_attack: 8, sp_defense: 8, speed: 10, level: 8, xp: 0, xpToNextLevel: 80, isFainted: false, sprite: 'https://pa1.aminoapps.com/6744/4f8b0d5940eda27c49a30dfa903c3c1321ac798d_hq.gif' },
            { id: 3, name: "PIKACHU", hp: 40, maxHp: 40, mp: 15, maxMp: 15, attack: 12, defense: 9, sp_attack: 10, sp_defense: 9, speed: 18, level: 7, xp: 0, xpToNextLevel: 70, isFainted: false, sprite: 'https://i.pinimg.com/originals/9f/b1/25/9fb125f1fedc8cc62ab5b20699ebd87d.gif' }
        ],
        inventory: {
